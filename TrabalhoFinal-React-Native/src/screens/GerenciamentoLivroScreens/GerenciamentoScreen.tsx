...
import stylesGerenciamento from "./stylesGerenciamento"; // Importação do arquivo de estilos

type NavigationProps = NativeStackNavigationProp<StackParamList, 'Gerenciamento'>;
